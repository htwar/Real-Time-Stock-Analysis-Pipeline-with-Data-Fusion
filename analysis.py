...
# Point to the other services inside Docker network
...
def log_config():
    logger.info(f"Using PRICE_SERVICE_URL={PRICE_SERVICE_URL}")
    logger.info(f"Using FUNDAMENTAL_SERVICE_URL={FUNDAMENTAL_SERVICE_URL}")
